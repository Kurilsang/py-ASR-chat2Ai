...
```bash
# 克隆项目
git clone https://github.com/your-repo/py-ASR-demo.git
cd py-ASR-demo
...
# 可选：安装额外TTS支持
pip install gtts pygame                    # Google TTS
...
- 项目地址：[https://github.com/your-repo/py-ASR-demo](https://github.com/your-repo/py-ASR-demo)
- 问题反馈：[Issues](https://github.com/your-repo/py-ASR-demo/issues)
